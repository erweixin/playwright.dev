...
```bash
pwsh bin/Debug/netX/playwright.ps1 codegen playwright.pro
```
...
```bash
pwsh bin/Debug/netX/playwright.ps1 codegen --viewport-size=800,600 playwright.pro
```
...
```bash
pwsh bin/Debug/netX/playwright.ps1 codegen --device="iPhone 11" playwright.pro
```
...
```bash
pwsh bin/Debug/netX/playwright.ps1 codegen --color-scheme=dark playwright.pro
```
