...
Create a `Program.cs` that will navigate to `https://playwright.pro/dotnet` and take a screenshot in Chromium.
...
await page.GotoAsync("https://playwright.pro/dotnet");
