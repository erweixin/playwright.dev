...
```bash
npx playwright codegen playwright.pro
```
...
```bash
npx playwright codegen --viewport-size=800,600 playwright.pro
```
...
```bash
npx playwright codegen --device="iPhone 11" playwright.pro
```
...
```bash
npx playwright codegen --color-scheme=dark playwright.pro
```
