...
We will create a `PlaywrightDevPage` helper class to encapsulate common operations on the `playwright.pro` page. Internally, it will use the `page` object.
...
export class PlaywrightDevPage {
  ...
  async goto() {
    await this.page.goto('https://playwright.pro');
  }
