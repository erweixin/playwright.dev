...
The stable and the `next` documentation is published on [playwright.pro](https://playwright.pro). To see the `next` documentation, press <kbd>Shift</kbd> on the keyboard `5` times.
