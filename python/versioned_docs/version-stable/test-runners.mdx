...
- `context`: New [browser context](https://playwright.pro/python/docs/browser-contexts) for a test.
- `page`: New [browser page](https://playwright.pro/python/docs/pages) for a test.

**Session scope**: These fixtures are created when requested in a test function and destroyed when all tests end.
- `playwright`: [Playwright](https://playwright.pro/python/docs/api/class-playwright) instance.
- `browser_type`: [BrowserType](https://playwright.pro/python/docs/api/class-browsertype) instance of the current browser.
- `browser`: [Browser](https://playwright.pro/python/docs/api/class-browser) instance launched by Playwright.
