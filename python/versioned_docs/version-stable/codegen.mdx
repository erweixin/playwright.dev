...
```bash
playwright codegen playwright.pro
```
...
```bash
playwright codegen --viewport-size=800,600 playwright.pro
```
...
```bash
playwright codegen --device="iPhone 11" playwright.pro
```
...
```bash
playwright codegen --color-scheme=dark playwright.pro
```
