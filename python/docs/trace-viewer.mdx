...
Playwright Trace Viewer is a GUI tool that helps exploring recorded Playwright traces after the script ran. Open traces [locally](#viewing-the-trace) or in your browser on [`trace.playwright.pro`](https://trace.playwright.pro).
...
You can open the saved trace using Playwright CLI or in your browser on [`trace.playwright.pro`](https://trace.playwright.pro).
...
## Using [trace.playwright.pro](https://trace.playwright.pro)

[trace.playwright.pro](https://trace.playwright.pro) is a statically hosted variant of the Trace Viewer. 

### Viewing local traces

When navigating to [trace.playwright.pro](https://trace.playwright.pro), you can upload trace files using drag and drop.
...
```txt
https://trace.playwright.pro/?trace=https://demo.playwright.pro/reports/todomvc/data/cb0fa77ebd9487a5c899f3ae65a7ffdbac681182.zip
```
